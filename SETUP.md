...
Exocortex - персональная система управления знаниями на основе графа знаний и LLM. MVP умеет хранить узлы и связи, извлекать сущности из текста через LLM или fallback-режим, работать через CLI и FastAPI.

## Требования

- Python 3.11 или выше
- pip
- API-ключ LLM опционален: без ключа используется fallback-извлечение
- Docker опционален
...
Текущий набор проверяет модели, репозиторий, LLM fallback, API-конфигурацию и CLI.
...
- LLM extraction pipeline с fallback-режимом
- REST API
